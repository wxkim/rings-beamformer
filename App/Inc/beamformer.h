...
//add code later for initializing-deinitalizing spi protocol with custom word sizes for command
...
typedef enum {
    ...
    BF_CMD_BROADCAST_WR = 0b10   // broadcast write (maps correctly to ctrl bits [59:58])
} bf_cmd_t;
